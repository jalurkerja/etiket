...
<html lang="en">
  <head>
	...
	<style>
		...
		.back-to-top, .btn-za, .slicknav_btn{
			background: #1CB9F7;
		}
		#copyright, .custom-file-label::after{
			background-color: #1CB9F7;
		}
		.post-header a, .navbar-expand-lg .navbar-nav li a:hover, .navbar-expand-lg .navbar-nav li .active > a, .navbar-expand-lg .navbar-nav li a:focus{
			color: #1CB9F7;
		}
		a{
			color: #1CB9F7;
...
<?php
	...
	$step_to					= "1";
	$step_to					= explode(".php",$__base_url)[0];
	$step_to					= (explode("_",$step_to)[1]*1);
	
	$is_active[$step_to]		= "active";	
