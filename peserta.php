...
if (isset($_POST["simpan"])) {
    ...
    if ($_SESSION["errormessage"] == "") {
        if ($return == "1") {
            $_SESSION["message"] = "Data Anda berhasil disimpan, jangan lupa untuk <i>follow</i> instagram kami di <br><a href='https://www.instagram.com/ptindohr/' target='_blank'>https://www.instagram.com/ptindohr/</a><br> untuk mengetahui update terbaru dari kami, Terima Kasih.";
